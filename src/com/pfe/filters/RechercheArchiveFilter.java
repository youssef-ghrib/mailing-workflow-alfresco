...
@WebFilter( "/faces/restreint/CourrierArrive/RechercheArchive/*" )
public class RechercheArchiveFilter implements Filter {
    ...
    public void doFilter( ServletRequest request, ServletResponse response, FilterChain chain ) throws IOException,
        ...
        if ( cnx != null && cnx.isLoggedIn()&& cnx.getEmploye().getRole().equals("ADMIN") ) {
